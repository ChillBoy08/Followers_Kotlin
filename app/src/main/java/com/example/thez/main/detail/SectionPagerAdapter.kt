...
import com.example.thez.main.fragment.FollowersFragment
import com.example.thez.main.fragment.FollowingFragment
...
class SectionPagerAdapter (private val mCtx: Context, fm:FragmentManager, data: Bundle) : FragmentPagerAdapter(fm, BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT) {
    ...
    private var fragmmentBundle: Bundle

    init {
        fragmmentBundle = data
    }
    ...
    override fun getItem(position: Int): Fragment {
        ...
        fragment?.arguments = this.fragmmentBundle
